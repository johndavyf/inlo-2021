<?php
    ...
    if (isset($_SESSION["idUser"])) 
    {
        ...
        if(isset($_POST['btndelete'])){
            ...
            echo   ('<script type="text/javascript"> alert(" L\'image retirée avec succes"); </script>');    
...
<div class="container jumbotron p-5 my-5 bg-dark shadow text-dark">
    <div class="jumbotron">
        <form id="form1" method="POST" action="delMedias.php">   
            <h1 class="text-center">Choisir une image à supprimer</h1><br> 
            <div class="row">                       
                <?php 
            ...
            <button type="submit" class="btn btn-success mt-5 " name="btndelete">Retirer</button>              
        </form>
    </div> 
