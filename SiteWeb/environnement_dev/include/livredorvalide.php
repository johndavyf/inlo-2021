...
<table class="table">
    ...
    <tbody>
    <?php
        $arraylivredorvalide=getLivredorvalide()->fetchAll();

        if (empty($arraylivredorvalide)){
            echo   ('<script type="text/javascript"> alert(" Il n\'y a pas de commentaire validé. "); </script>');
        }
        else{
            foreach($arraylivredorvalide as $texttab ){
                ?>
                    <tr>
                        <td> 
